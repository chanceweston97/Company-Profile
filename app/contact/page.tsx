    ...
    >
      ...
      >
        ...
        <div className="relative mx-auto flex w-full max-w-[896px] flex-col items-center">
          ...
          >
            Have a project in mind? As an AI development company in Texas, we&apos;d love to hear from you. Send us a message
      ...
      {/* Contact content */}
      <section className="bg-white px-8 py-24 md:px-20" aria-labelledby="contact-section-heading">
